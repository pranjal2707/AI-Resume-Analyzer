...
from lj.resume_parser import ResumeParser
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/lakshya1402" style="text-decoration: none; color: #021659;">Lakshya and Group</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="https://github.com/lakshya1402" style="text-decoration: none; color: grey;">Lashya Bisen</a> through 
            <a href="https://www.linkedin.com/in/lakshya-bisen-153b11330/" style="text-decoration: none; color: grey;">Rocford Softsol Institute</a>
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            ## Credentials 
            if ad_user == 'admin' and ad_password == 'Lashya@14':
                ...
                st.success("Welcome Lakshya ! Total %d " % values + " User's Have Used Our Tool : )")                
